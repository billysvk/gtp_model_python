...
def generate_text(prompt):
    ...
    #                              num_return_sequences=num_sequences,  # Generate multiple sequences
    ...
    #                              num_beam_groups=num_beam_groups,  # Number of beam groups for diverse beam search
    #                              diversity_penalty=diversity_penalty,  # Diversity penalty for diverse beam search
    #                              )
    

    temperature = 1.0  # Adjust as needed (higher values for more diversity)
